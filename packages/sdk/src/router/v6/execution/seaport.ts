...
export async function createSeaportExecution(
    chainId: number,
    seaportModule: Contract,
    currencyDetails: ListingDetailsExtracted[],
    exchange: Sdk.Seaport.Exchange,
    ...
    const { totalPayment, orders, totalPrice, fees } = getSeaportListingsPayment(currencyDetails, details, options);
